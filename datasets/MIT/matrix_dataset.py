...
from datasets.MIT.providers.matrix_examples_provider import MatrixExamplesProvider

class MatrixDataset(BaseMITDataset):
    def __init__(self, params):
        super(MatrixDataset, self).__init__(params, 
            examples_provider=MatrixExamplesProvider(params)
        )
